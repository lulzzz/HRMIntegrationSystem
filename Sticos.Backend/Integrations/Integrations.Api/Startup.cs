...
namespace Integrations.Api
{
    public class Startup : IConfigurableStartUp
    {
        ...
        {
            _logger.LogInformation("Startup: ConfigureServices Integrations-Api");
            ...
            if (messageBusEnabled)
            {
                ...
                services.AddMessageBus(new MessageBusConfig
                {
                    ...
                    AssemblyNamesToScan = new[] { "Integrations.Api.MessageBus" },
            ...
            {
                c.SwaggerDoc("v1", new Info { Title = "Sticos Integrations Api", Description = "Swagger Sticos Integrations Api" });

                var xmlPath = System.AppDomain.CurrentDomain.BaseDirectory + @"Integrations.Api.xml";
        ...
        public void Configure(IApplicationBuilder app)
        {
            ...
            {
                app.UseSwagger();
                app.UseSwaggerUI(c => { c.SwaggerEndpoint("/swagger/v1/swagger.json", "STICOS INTEGRATIONS API"); });
            }
